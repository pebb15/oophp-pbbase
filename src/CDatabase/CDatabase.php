...
/**
   ...
   * @return boolean returns TRUE on success or FALSE on failure. 
   */
  public function getRows($query, $params = array(), $debug=false) {
  ...
  /**
   * Hämta rader i sista sql-anropet
   *
   * @return rows in last search
   */
  public function GetRowsInSearch() {
		return $this->rowsInSearch;
  }
